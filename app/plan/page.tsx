...
export default function PlanPage({ searchParams }: { searchParams?: { show?: string } }) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      <BreadcrumbSchema items={[{ name: "Plan My Night", url: `${SITE_URL}/plan` }]} />
      ...
      <div className="bg-paper border-2 border-primary/40 rounded-lg p-5 mb-8">
        <PlanBuilder shows={shows} initialShowId={searchParams?.show} />
      </div>
